...
const USER_KEY = 'number-baseball-user-v1'
const AUDIO_KEY = 'number-baseball-audio-v1'
const AUDIO_CONSENT_KEY = 'number-baseball-audio-consent-v1'

const LEGACY_USER_KEY = 'code-cracking-user-v1'
const LEGACY_AUDIO_KEY = 'code-cracking-audio-v1'
const LEGACY_AUDIO_CONSENT_KEY = 'code-cracking-audio-consent-v1'

const LEGACY_USER_KEY_V0 = 'mindbreaker-user-v1'
const LEGACY_AUDIO_KEY_V0 = 'mindbreaker-audio-v1'
const LEGACY_AUDIO_CONSENT_KEY_V0 = 'mindbreaker-audio-consent-v1'
...
export function loadUser(): UserProfile | null {
  const raw = localStorage.getItem(USER_KEY) ?? localStorage.getItem(LEGACY_USER_KEY) ?? localStorage.getItem(LEGACY_USER_KEY_V0)
  if (!raw) return null
...
export function loadAudioSettings(): AudioSettings {
  const raw = localStorage.getItem(AUDIO_KEY) ?? localStorage.getItem(LEGACY_AUDIO_KEY) ?? localStorage.getItem(LEGACY_AUDIO_KEY_V0)
...
export function hasAudioConsent(): boolean {
  return (localStorage.getItem(AUDIO_CONSENT_KEY) ?? localStorage.getItem(LEGACY_AUDIO_CONSENT_KEY) ?? localStorage.getItem(LEGACY_AUDIO_CONSENT_KEY_V0)) === 'true'
}
